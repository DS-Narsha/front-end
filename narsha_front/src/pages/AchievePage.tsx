      ...
      <ScrollView>
        ...
        <View style={styles.achieveContainer}>
          ...
          <AchieveItem
            ...
            progress={'진행 중'}
            hint={'친구들은 여러분이 작성한 게시글에 좋아요를 눌러줄 거예요!'}
          />
          <AchieveItem
          ...
          <AchieveItem
            title={'업적 5회 달성하기'}
            content={'업적을 5개 달성해 보아요!'}
            progress={'진행 중'}
            hint={'업적의 힌트를 따라 열심히 달성하다 보면 뭔가 좋은일이 생길지도 모릅니다!'}
          />
          <AchieveItem
            title={'선생님이 올리신 공지 확인하기'}
            content={
          ...
          />
          <AchieveItem
            title={'친구 10명 게시글에 좋아요 10개 달기'}
            content={
              '여러 친구들의 게시글을 둘러보면서 좋아요를 10번 눌러볼까요?'
            }
            progress={'진행 중'}
            hint={
